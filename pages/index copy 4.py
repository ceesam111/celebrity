...
class Index(Container):
  def __init__(self,switch_page,pg):
                                  ...
                                  content=Column(controls=[
                                      ...
                                      Container(content=Row(alignment='start',controls=[
                                        ...
                                        Container(content=Row(alignment='start',controls=[
                                            ft.Row(
                                                      controls=[
                                                          ft.Row(controls=[like_icon, Text(f"{likeme}")], spacing=5),
                                                          ft.Row(controls=[love_icon, Text(f"{loveme}")], spacing=5),
    ...
    open_drawer_button = ElevatedButton(
        text="Open Drawer",
        on_click=lambda e: pg.show_drawer(drawer)
    )
    
    
    self.pg.appbar = ft.AppBar(
        leading=IconButton(
                            icon=icons.MENU, 
        ...
        actions=[
            ...
            ft.PopupMenuButton(
                items=[
                    ...
                    ft.PopupMenuItem(
                        text="Checked item", checked=False, on_click=pg.show_drawer(drawer)
                    ),
                ]
            ),
        ],
                          ...
                          controls=[
                            ...
                            FilledButton(
                              # "Get Started",
                                content=Text(
                                    "Get Started",
                                    size=((pgw * 1)/100),  # Set the desired text size
                                ),
                                width=((pgw * 2)/100)*4,  # Set the desired width
                                # height=(pgw * 4)/100,  # Set the desired height
                                style=ButtonStyle(
                                  # color= '#5525c9',
                                    bgcolor = '#f5c000',
                                    overlay_color= colors.WHITE,
                                    shape=RoundedRectangleBorder(radius=(pgw * 1)/100),
                                    color={
                                        MaterialState.HOVERED: colors.BLACK,
                                        MaterialState.FOCUSED: colors.BLACK,
                                        MaterialState.DEFAULT: colors.BLACK,
    ...
    self.content = Stack(  
        ...
        controls=[ self.homepages,self.Dappbar]
      )
    ...
    if pgw >= 576:
        ...
        if self.Dappbar not in self.content.controls:
            ...
            self.content.controls.append(self.homepages)
        ...
        self.pg.update()
    elif self.Dappbar in self.content.controls or self.Mappbar not in self.content.controls:
